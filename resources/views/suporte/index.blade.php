        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3 bg-info">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Meta Atual</span>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3 bg-info">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Positivação (MENSAL)</span>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3 bg-info">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Treinamentos</span>
            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-footer clearfix">
                        <a href="javascript:void(0)" class="btn btn-sm btn-success float-left">Nova Solicitação</a>
                        <a href="javascript:void(0)" class="btn btn-sm btn-info float-right">Visualizar todas</a>
                    </div>
                        ...
                        <ul class="products-list product-list-in-card pl-2 pr-2">
                            <li class="item">
                                <div class="product-img">
                                    <img src="{{ url('/') }}/storage/config/150x150.png" alt="Product Image"
                                        class="img-size-50">
                                </div>
