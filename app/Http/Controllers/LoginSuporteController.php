...
class LoginSuporteController extends Controller
{
    ...
    public function Login(Request $request)
    {
        ...
        if(!$usuario){
            return redirect()->action('LoginSuporteController@form')->with('status_login_error', 'Usuário inexistente!');
        }
        ...
        if($statusUser->ativo==0){
            return redirect()->action('LoginSuporteController@form')->with('status_login_error', 'Usuário Inativo!');
        }else{
            return redirect()->action('LoginSuporteController@form')->with('status_login_error', 'Por favor, verifique os dados!');
        }
